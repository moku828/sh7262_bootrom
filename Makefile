all:
	...
	sh-elf-ld -Tsh7262_boot.ld -nostartfiles -o bootrom.elf asmfunc.o test_bitop.o test_datatrans.o test_sysctrl.o test_bra.o
	sh-elf-objcopy -j .text -j .data -O binary bootrom.elf bootrom.bin
clean:
	rm bootrom.elf bootrom.bin asmfunc.o test_bitop.o test_datatrans.o test_sysctrl.o test_bra.o
